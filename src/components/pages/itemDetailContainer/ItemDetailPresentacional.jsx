...
const ItemDetailPresentacional = ({ productSelected }) => {
    return (
        <section className="itemDetail_container_total">
            <div className="itemDetail_container">
                <div className="itemDetail_product_container">
                    <img src={`../../src/assets/images/store/${productSelected.nombreImagen}`} alt={productSelected.nombre}></img>
                    <aside className="itemDetail_buy">
                        <div className="itemDetail_buy_details">
                            <h1>{productSelected.nombre}</h1>
                            <span>${productSelected.precio}</span>
                        </div>
                ...
                <div className="itemDetail_info_container">
                    ...
                    <div className="itemDetail_info_overview">
                        ...
                        <div className="itemDetail_info_overview_p">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis deleniti molestiae est error! Ratione quae rem praesentium odio id molestias quisquam mollitia, ex laboriosam libero provident sint? Laborum, dolorem maiores.</p>
                        </div>
                    </div>
                    <div className="itemDetail_info_box">
                        ...
                        <div className="itemDetail_info_box_p">
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officiis, aliquid.</p>
                        </div>
                    </div>
